...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_path', default=r'D:/Github/ConfFold/data/QM9/qm9', type=str)
    parser.add_argument('--dataset_name', type=str, default='qm9', choices=['qm9', 'drugs'])
    ...
    parser.add_argument('--confmin', type=int, default=1)
    parser.add_argument('--confmax', type=int, default=50)            
